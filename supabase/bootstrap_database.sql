...
CREATE POLICY "Anon can insert friendly matches" ON public.friendly_matches
...
CREATE POLICY "Anon can insert elo ratings" ON public.elo_ratings
  FOR INSERT TO anon WITH CHECK (true);

CREATE POLICY "Anon can update elo ratings" ON public.elo_ratings
